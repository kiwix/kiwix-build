...
main_project_versions = {
    'kiwix-lib': '9.1.0',
    'kiwix-tools': '3.1.0', # Also need to change this in appveyor/install_kiwix-tools.cmd
    'libzim': '6.1.0',
    'zim-tools': '1.1.0',
    'zimwriterfs': '1.3.9',
    'kiwix-desktop': '2.0' # Also change KIWIX_DESKTOP_VERSION and KIWIX_DESKTOP_RELEASE in appveyor.yml
