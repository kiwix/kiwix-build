...
curl --insecure -fsSL -o pkg-config-lite-0.28-1.zip https://freefr.dl.sourceforge.net/project/pkgconfiglite/0.28-1/pkg-config-lite-0.28-1_bin-win32.zip || exit /b 1
