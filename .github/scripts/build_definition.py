...
DESKTOP         | eval'True |                                                                           |                                                                                                                                                                         |
OS_NAME         |           | bionic      |  osx                                                        |                                                                                                                                                                         |
PLATFORM_TARGET |           | re'.*_mixed |  native_mixed  | re'.*_static | re'iOS_* | re'macOS_*_mixed | re'android_.* | native_mixed | armhf_mixed | aarch64_mixed | wasm | native_static | native_dyn | win32_static | re'armhf_.* | re'aarch64_.* | i586_static | flatpak |   |
===================================================================================================================================================================================================================================================================================
libzim          |           | x                            |              | x                           | x                                                                 |                                                                                                 | x |
libkiwix        |                         |  x             |              | x                           | x                            |                                                                                                                                      | x |
zim-tools       |                                          | x            |                             |                                                                   | x                                                                                     |         | x |
