...
OS_NAME         | bionic |  osx                                           |                                                                                                                                                     |
DESKTOP         |                                                         | eval'True |                                                                                                                                         |
PLATFORM_TARGET |        |  native_mixed  | native_dyn | re'.*_static |   |           | flatpak | re'android_.* | native_mixed | re'*_mixed | wasm | re'native_* | win32_static | re'armhf_.* | re'aarch64_.* | i586_static |   |
=================================================================================================================================================================================================================================
libzim          | x                       |                           | x |                     | x                                                |                                                                        | x |
libkiwix        |        |  x             |                           | x |                     | x                            |                                                                                            | x |
zim-tools       |                         | x                         |   |                                                                        | x                                                                      | x |
